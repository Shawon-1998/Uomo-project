        ...
        <section>
            ...
            <div className='flex gap-15.5 mb-10 items-center'>
                <div className='after:bg-primary-black relative leading-6 after:absolute after:bottom-0 after:left-0 after:h-0.5   after:content-[""] after:w-full'>
                    <select className='text-primary-black font-jost font-medium text-sm border-none outline-none  ' name="" id="">
                ...
                <div className='font-jost font-medium text-sm flex items-center gap-2.5 '>
                    ...
                    <h3 className='hoverItems '>FILTER</h3>
                </div>
